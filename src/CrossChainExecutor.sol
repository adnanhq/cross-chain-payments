...
contract CrossChainExecutor is ICrossChainExecutor, Ownable, Pausable {
     ...
     */
    function setSelectors(bytes4[] calldata selectors, bool allowed) external onlyOwner {
     ...
     */
    function setIntentSenders(uint256[] calldata chainIds, address[] calldata intentSenders) external onlyOwner {
     ...
     */
    function setCcipChainSelectors(uint256[] calldata chainIds, uint64[] calldata selectors) external onlyOwner {
